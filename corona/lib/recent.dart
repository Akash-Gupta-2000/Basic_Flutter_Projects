          ...
          child: Column(
            children: <Widget>[
              Card( margin:EdgeInsets.all(3) ,
                  child: Container(padding:EdgeInsets.all(5),child: Text('List of Top 10 countries with most corona cases in last 24 hours',style: TextStyle(color: Colors.blue,fontStyle: FontStyle.italic,letterSpacing: 1.5,fontSize: 14),),))
            ],
          ),
