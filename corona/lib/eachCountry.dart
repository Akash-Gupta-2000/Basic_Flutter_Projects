                ...
                children: <Widget>[
                  ...
                  RichText(
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(text: '+ ${converting(widget.newrecovered)}', style: TextStyle(fontWeight: FontWeight.bold,color: Colors.green,fontSize: 15)),
                      ],
                    ),
                  ),
                ],
                     ...
                     children: <Widget>[
                       ...
                       RichText(
                         text: TextSpan(
                           ...
                           style:TextStyle(fontSize: 24,color: Colors.red,fontWeight: FontWeight.w900),
                           children: <TextSpan>[
                             TextSpan(text: '+ ${converting(widget.newdeath)}', style: TextStyle(fontWeight: FontWeight.bold,color: Colors.green,fontSize: 15)),
                           ],
                         ),
                       ),
                     ],
                     ...
                     children: <Widget>[
                       ...
                       RichText(
                         text: TextSpan(
                           ...
                           style:TextStyle(fontSize: 24,color: Colors.red,fontWeight: FontWeight.w900),
                           children: <TextSpan>[
                             TextSpan(text: '+ ${converting(widget.newcase)}', style: TextStyle(fontWeight: FontWeight.bold,color: Colors.green,fontSize: 15)),
                           ],
                         ),
                       ),
                     ],
                ...
                if(snapshot.data==[]){
                  ...
                  return Container(
                    child: Center(
                      ...
                      {
                        return deathgraph(liveData: snapshot.data,);
                      }
              }
